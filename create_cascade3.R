...
source('visualise_cascade_function3.R')
...
visualise_cascade3(data = df, order_reasons = 'AZ')
visualise_cascade3(data = df, order_reasons = 'ascend')
visualise_cascade3(data = df, order_reasons = 'descend')
...
ggsave('cascade3.pdf', height = 6.8, width = 7.8)
ggsave('cascade3.png', height = 6.8, width = 7.8)
