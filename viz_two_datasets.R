...
#this was fn_name3()
viz_two_datasets <- function(data1, data2, opacity = 0.7, spacing = 0.01,
  ...
  data1$pc_cs1 <- NA
  data1$pc_cs2 <- NA
  totl1 <- sum(data1[data1$level==1,]$N)
  for(i in 2:4){
    ...
    data1[data1$level==i,]$pc_cs1 <- data1[data1$level==i,]$cs1 /totl1
    data1[data1$level==i,]$pc_cs2 <- data1[data1$level==i,]$cs2 /totl1
  }
  data1
  ...
  data2$pc_cs1 <- NA
  data2$pc_cs2 <- NA
  totl2 <- sum(data2[data2$level==1,]$N)
  for(i in 2:4){
    ...
    data2[data2$level==i,]$pc_cs1 <- data2[data2$level==i,]$cs1 /totl2
    data2[data2$level==i,]$pc_cs2 <- data2[data2$level==i,]$cs2 /totl2
  }
  data2
